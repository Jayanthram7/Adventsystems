        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="p-6 space-y-4 h-64 overflow-y-auto">
            ...
            <div className="flex items-start space-x-3 justify-end">
              <div className="bg-tally-blue text-white rounded-lg p-3 max-w-xs">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            {messages.map((message) => (
              <div key={message.id} className={`flex items-start space-x-3 ${message.isUser ? 'justify-end' : ''}`}>
                {!message.isUser && (
                  <div className="w-10 h-10 bg-tally-blue rounded-full flex items-center justify-center flex-shrink-0">
            ...
            {chatMutation.isPending && (
              <div className="flex items-start space-x-3">
                <div className="w-10 h-10 bg-tally-blue rounded-full flex items-center justify-center">
                  <Bot className="h-5 w-5 text-white" />
                </div>
          ...
          <div className="border-t border-gray-200 p-6 flex-shrink-0">
            <div className="flex space-x-4">
              ...
              <Button 
                ...
                className="bg-tally-orange hover:bg-tally-orange-hover text-white px-6"
              >
                Send
                <Send className="h-4 w-4 ml-2" />
              </Button>
